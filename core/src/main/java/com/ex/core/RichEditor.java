...
public class RichEditor extends WebView {
    ...
    public static final String BOLD_AND_ITALIC = "" + Type.BOLD + "," + Type.ITALIC;
    ...
    private void stateCheck(String text) {
        ...
        for (Type type : Type.values()) {
            if (TextUtils.indexOf(state, type.name()) != -1) {
                types.add(type);
//                Log.d(getClass().getName(),"__________________"+type);
            }
        }
    ...
    public void loadHtml(String contents) {
        if (contents == null) {
            contents = "";
        }
        try {
            exec("javascript:RE.setHtml('" + URLEncoder.encode(contents.trim()
                    .replaceAll("(<br[^>]*>\\s*)+$", ""), "UTF-8") + "');");
    ...
    public void setEditorBackgroudResouce(int resId) {
  ...
  /*     @Override
        public void setBackgroundResource(int resid) {
            ...
            exec("javascript:RE.setBackgroundResource('url(data:image/xml;base64," + base64 + ")');");
        }*/
    @Override
    public void setBackground(Drawable background) {
        ...
        exec("javascript:RE.setBackgroundImage('url(data:image/xml;base64," + base64 + ")');");
    }
    ...
    public void setEditorHeight(int px) {
        exec("javascript:RE.setHeight('" + px + "em');");
    }
    ...
    public void setFontStyle(TextAppearance appearance) {
        exec("javascript:RE.setBaseTextAppearance('" + appearance + "');");
    }
