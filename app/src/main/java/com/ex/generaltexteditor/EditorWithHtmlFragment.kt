...
import com.ex.generaltexteditor.databinding.FragmentEditorWithHtmlBinding

class EditorWithHtmlFragment : Fragment() {
    private var _binding: FragmentEditorWithHtmlBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditorWithHtmlBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.tvHtmlText.visibility = View.VISIBLE
        ...
        binding.editor.setOnTextChangeListener { text -> binding.tvHtmlText.text = text }
        setEditorState()
